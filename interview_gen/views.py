            ...
            messages=[
                {
                    'role': 'system', 
                    'content': f"""
                                    너는 이제부터 한글로 면접관과 지원자의 롤플레이를 할 거야. 외국어를 사용해서는 안돼.
                                    {prompt_context}
                                    ...
                                    * 지원자의 답변 바로 뒤에 뉴스 링크를 넣어야 하며, 형식은 <a href="링크" target="_blank"><b>▶ 관련 뉴스 링크 바로가기</b></a>와 같아야 해.
                                    ...
                                    * 이 섹션의 질문에는 뉴스 링크를 추가하지 말아줘.
                                    ...
                                    <p class="question">질문 내용 1</p><p class="answer">답변 내용 1 <br></br><a href="링크" target="_blank"><b>▶ 관련 뉴스 링크 바로가기</b></a></p>
                                    <p class="question">질문 내용 2</p><p class="answer">답변 내용 2 <br></br><a href="링크" target="_blank"><b>▶ 관련 뉴스 링크 바로가기</b></a></p>
